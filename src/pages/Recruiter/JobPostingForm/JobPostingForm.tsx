    ...
    <div className="job-posting-form">
      ...
      >
        <Form.Item
          ...
          name="jobTitle"
          rules={[
            { required: true, message: "Please enter the title of job!" },
          ]}
        >
          <Input
            placeholder="Please enter the title of job"
            autoComplete="off"
          />
        </Form.Item>
          ...
          rules={[
            {
              ...
              validator(_, value) {
                ...
                return Promise.reject(
                  new Error("Experience in number like 2.5 or 4!")
                );
              },
            },
          ]}
        >
          <Input
            placeholder="Experience in number like 2.5 or 4"
            autoComplete="off"
          />
        </Form.Item>
        ...
        >
          <Input
            placeholder="Annual salary in lacs like 5.5 or 7"
            autoComplete="off"
          />
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Please enter a brief discription about the job!",
            },
          ]}
        >
